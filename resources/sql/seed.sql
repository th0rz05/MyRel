...
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(1 ,'09:32 · 01 jan. 2023','10 Python Mini Automation Projects','https://www.sphereinc.com/wp-content/uploads/2021/07/Python-and-machine-learning-blog-header.webp','Family');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(1 ,'09:39 · 01 jan. 2023','The best ADVANCED techniques I learned while building in public last month was How to use Chrome Inspect Console properly, especially the Network - Fetch/XHR - Responses feature','https://www.itsecurityguru.org/wp-content/uploads/2022/05/arget-zvHhKiVuR9M-unsplash-scaled.jpg',NULL);
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(18,'11:30 · 01 jan. 2023','Halloween is coming','https://media.cnn.com/api/v1/images/stellar/prod/210922143623-pet-halloween-costumes-lead.jpg?q=x_0,y_0,h_2532,w_4499,c_fill/h_720,w_1280',NULL);
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(6 ,'16:20 · 01 jan. 2023','October traffic has been in the red so far. Heres how I plan to make it green: Create helpful and relevant posts in communities (Reddit, Facebook, IH). Run an engineering as marketing campaign. Experiment with content marketing. As usual, will share everything here.','https://c4.wallpaperflare.com/wallpaper/646/235/690/icons-social-media-social-media-wallpaper-preview.jpg','Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(5 ,'01:43 · 02 jan. 2023','Puppy thinks hes a bunny...','https://images.fineartamerica.com/images/artworkimages/mediumlarge/1/wp11895-baby-sandy-lop-rabbit-with-sleepy-golden-retriever-pup-warren-photographic.jpg','Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(5 ,'01:59 · 02 jan. 2023','The Psychology of Manipulation You Should Know Before Its Too Late...','https://content.sintelly.com/articles/UOtgCx0zKsl6imeivLuq/content/dark-psychology-manipulation-and-mind-control-0-@sintelly.jpeg','Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(24,'02:36 · 02 jan. 2023',' Hacked filter: sepia() to colorize white walls by masking them with a canvas from an image from auto detected segment that adds it as a image-mask to the image. So that you user can soon colorize any walls with a slider','https://www.lunapic.com/editor/premade/sepia.gif','Family');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(5 ,'04:30 · 02 jan. 2023','-you*','https://blog.petiko.com.br/wp-content/uploads/2022/10/Design-sem-nome-18-scaled.jpg','Family');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(16,'09:49 · 02 jan. 2023','20 must-watch movies that will change your life & mindset: 1. Schindler’s List','https://wallpaperaccess.com/full/2006556.jpg',NULL);
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(7 ,'16:42 · 02 jan. 2023','Let us not forget the Indian version of Michael Jacksons THRILLER!','https://1.bp.blogspot.com/-LEmiPjLZs94/XWf8kYyjA1I/AAAAAAADnUQ/zcTmiemQ4Ec_KSo0O7wNshWHaow6c9K1wCLcBGAs/s1600/golimar-indian-thriller.jpg',NULL);
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(4 ,'04:16 · 03 jan. 2023','Heading for a $5k+ month. Someone once told me I`d never make it into the 40% tax bracket and yet here we are. A big thanks to all my clients, sponsors and supporters','https://dc-cdn.s3-ap-southeast-1.amazonaws.com/dc-Cover-qsm384jk7nnt0cehjkdj3trri3-20160408004801.Medi.jpeg',NULL);
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(25,'08:36 · 03 jan. 2023','Congratulations to Ulf Kristersson ,@moderaterna, on being elected PM of Sweden. Im sure - cooperation will continue active development, and ’s support in the fight against Russian aggression will increase. I am grateful to Magdalena Andersson for solidarity & supporting .','https://s3.operamundi.uol.com.br/thumb/8351537fd37c57383ff940320205af88_8d031a0218665282e816e973f7022368.png','Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(21,'13:52 · 03 jan. 2023','Steps to become a data analyst (my preference) :SQL, Storytelling with data, (Tableau/ PowerBI), Build dashboards ,Python, ,Visualization libraries, (Pandas, Matplotlib, NumPy, Seaborn), Portfolio projects, (From data cleaning → Data analysis)','https://media.istockphoto.com/id/913219882/photo/financial-graph-on-technology-abstract-background.jpg?b=1&s=170667a&w=0&k=20&c=aFXB_2Bn_T7weuTYIqZAs8sIja9MHcT-u-TlBVftvqo=','Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(14,'14:29 · 03 jan. 2023','En route to SF for TechCrunch Disrupt. Seems like we have a fun crew here already. Who else should I meet? And who wants to join our tech crew?','https://api.techpost.com.br/wp-content/uploads/2021/09/laborit-techcrunch-disrupt-.-1-1064x632.png','Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(7 ,'15:08 · 03 jan. 2023','A historic failure','https://historyhustle.com/wp-content/uploads/2021/04/biggest-fails-history.jpg','Family');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(5 ,'21:31 · 03 jan. 2023','Trabalhe mais feliz com os portáteis HP com a plataforma Intel® Evo™. Com a funcionalidade HP de redução do ruído pode trabalhar de onde quiser, quando quiser.','https://picsum.photos/id/1/200/300','Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(24,'22:08 · 03 jan. 2023','Uncanny ','https://www.theparisreview.org/blog/wp-content/uploads/2019/09/5475199813_114f842f0d_o-1024x573-1024x573.jpg','Family');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(5 ,'01:58 · 04 jan. 2023','Mountain Climber Fights Off Bear (2022)','https://images.ladbible.com/resize?type=jpeg&quality=70&width=720&fit=contain&gravity=null&dpr=1&url=https://eu-images.contentstack.com/v3/assets/bltcd74acc1d0a99f3a/blt0ac954abe1f53334/634e677857c30050d493cb15/bearstry.JPG.jpg','Close Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(17,'04:50 · 04 jan. 2023','Playful bear seems to dance in the forest','https://i.dailymail.co.uk/i/pix/scaled/2014/01/24/article-2545411-1AEECA9300000578-792_636x382.jpg','Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(9 ,'12:12 · 04 jan. 2023','Lose your belly fat','https://i.ytimg.com/vi/qTBfmwHN3_I/maxresdefault.jpg','Close Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(19,'15:37 · 04 jan. 2023','Submitting Tailscan to the Chrome Web Store later today! Yesterday, I finished one of the last core features:,,Tailwind CSS config support! You can save your own config so that all your custom classes and variants are available','https://picsum.photos/id/2/200/300','Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(3 ,'17:09 · 04 jan. 2023','mhuaw','https://wallpaperstock.net/wallpapers/thumbs1/42665hd.jpg','Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(24,'21:03 · 04 jan. 2023','If you want to build an African startup, its not about copying the Silicon Valley model.,,Its about finding the *African* way to do things. Different problems, different contexts, different solutions.','https://www.menosfios.com/wp-content/uploads/2022/02/AfricanStartups.jpeg','Friends');
INSERT INTO posts(user_id,date, text, photo, visibility) VALUES(23,'22:52 · 04 jan. 2023','Do you work in English? Check our specialized search engine for English-speaking professionals looking for opportunities in Portugal.','https://www.europelanguagejobs.com/uploads/posts/how-good1.jpg','Family');

INSERT INTO comments(user_id, post_id,date, text) VALUES(2, 1 ,'12:10 · 02 jan. 2023', 'Thank you for the information');
INSERT INTO comments(user_id, post_id,date, text) VALUES(1, 3 ,'19:45 · 02 jan. 2023', 'I will try it');
INSERT INTO comments(user_id, post_id,date, text) VALUES(3, 5 ,'08:21 · 03 jan. 2023', 'Thats really nice!!!');
INSERT INTO comments(user_id, post_id,date, text) VALUES(4, 1 ,'14:23 · 03 jan. 2023', 'I will try it it soon, thank you');
INSERT INTO comments(user_id, post_id,date, text) VALUES(4, 4 ,'17:11 · 03 jan. 2023', 'I dont know if it will work');
INSERT INTO comments(user_id, post_id,date, text) VALUES(5, 1 ,'20:20 · 03 jan. 2023', 'I think that building a website is not that hard');
INSERT INTO comments(user_id, post_id,date, text) VALUES(5, 2 ,'21:12 · 03 jan. 2023', 'Well deserved. You write good content. Glad to have you here');
INSERT INTO comments(user_id, post_id,date, text) VALUES(6, 4 ,'01:40 · 04 jan. 2023', 'Cheers to more good reads.');
INSERT INTO comments(user_id, post_id,date, text) VALUES(6, 1 ,'05:19 · 04 jan. 2023', 'I use Linkedin mainly to offer and find new job opportunities.');
INSERT INTO comments(user_id, post_id,date, text) VALUES(19, 1,'20:58 · 04 jan. 2023', 'I wish you the best for 2022!!!');
INSERT INTO comments(user_id, post_id,date, text) VALUES(13, 7,'23:59 · 04 jan. 2023', 'I am not a master. but I like Master of Puppets and I have been a D&D Dungeon Master. does it count?');
INSERT INTO comments(user_id, post_id,date, text) VALUES(14, 7,'02:37 · 05 jan. 2023', 'Wishing you more success and great year');


INSERT INTO replies(user_id, comment_id,date, text) VALUES(1, 1, '15:23 · 02 jan. 2023','You are welcome :)');
INSERT INTO replies(user_id, comment_id,date, text) VALUES(2, 2, '22:15 · 02 jan. 2023','Cheers to more good reads.');
INSERT INTO replies(user_id, comment_id,date, text) VALUES(9, 5, '23:40 · 03 jan. 2023','I am glad you liked it');
INSERT INTO replies(user_id, comment_id,date, text) VALUES(10, 1,'01:39 · 04 jan. 2023', 'Looking forward to learn more from you in 2022.');
INSERT INTO replies(user_id, comment_id,date, text) VALUES(16, 6,'05:18 · 04 jan. 2023', 'Good luck on your journey Captain!');
INSERT INTO replies(user_id, comment_id,date, text) VALUES(11, 6,'09:50 · 04 jan. 2023', 'Will always follow you');
INSERT INTO replies(user_id, comment_id,date, text) VALUES(12, 8,'12:10 · 04 jan. 2023', 'You are definitely a great person, already following you.');
INSERT INTO replies(user_id, comment_id,date, text) VALUES(18, 9,'19:57 · 04 jan. 2023', 'Have just downloaded Docker to complete @freeCodeCamp Relational Database Cert using Docker and VSCode... wish me luck!');
...
INSERT INTO relationships(user_id, related_id, type,state) VALUES(5, 1, 'Close Friends','pending');
INSERT INTO relationships(user_id, related_id, type,state) VALUES(1, 6, 'Friends','accepted');
INSERT INTO relationships(user_id, related_id, type,state) VALUES(7, 1, 'Family','pending');
